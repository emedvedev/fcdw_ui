...
@Controller
@RequestMapping("realtimeeseo")
public class RealtimeEseoController extends AbstractService {
	...
	private static final Logger LOGGER = Logger.getLogger(RealtimeEseoController.class.getName());
	...
	public ModelAndView realtime(@QueryParam(value = "satelliteId") Long satelliteId) {
		...
		ModelAndView mv = new ModelAndView("realtimeeseo");
