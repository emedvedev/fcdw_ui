...
<ul>
	<c:choose>
		<c:when test="${satelliteId == 2}">
		    ...
		    <li><a href="<c:url value='/home.html?satelliteId=0'/>">FUNcube Eng. Model</a></li>
		    <li><a href="<c:url value='/home.html?satelliteId=3'/>">FUNcube Test Stack</a></li>
		    <li><a href="<c:url value='/home.html?satelliteId=1'/>">UKube-1 FC Module</a></li>
    	</c:when>
	    <c:when test="${satelliteId == 0}">
    		<li><a href="<c:url value='/home.html?satelliteId=2'/>">FUNcube Flight Model</a></li>
